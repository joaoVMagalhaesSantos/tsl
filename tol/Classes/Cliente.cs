...
public class ClienteConst {
    public static void cadClie(int cliCod, int cliNom, string cliEnd, string cliBai, string cliCid, string numero, string cliCep, string cliTel, string cliTel2, string celular, string cliCon, string email, string seq004) {
        ...
        novoCliente.Add(new MySqlParametro("@clicon", cliCon));
